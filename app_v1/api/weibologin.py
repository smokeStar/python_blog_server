...
def get_access_token():
	...
	url  = "https://api.weibo.com/oauth2/access_token?client_id=1981969326&client_secret=xxx&grant_type=authorization_code&redirect_uri=http%3a%2f%2fwww.wenjian.group&code="+code
	postData = {}
	try:
		...
		if response.status_code == 200:
			...
			return jsonify({"result":False, "message":"请求失败"})
